...
112	7	7	{"doctorId":7,"authorId":7,"visitDate":"2023-10-27T07:00:01.520Z","patientId":45,"procedureId":3}	create	2023-10-27 07:00:01.52	2023-10-31 03:16:32.463
\.
...
684	2023-10-27 07:00:01.52	7	45	3	7
\.
...
SELECT pg_catalog.setval('public.history_id_seq', 112, true);
...
SELECT pg_catalog.setval('public.patient_id_seq', 45, true);
...
SELECT pg_catalog.setval('public.visit_id_seq', 684, true);
